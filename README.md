...
Static sites are the future of Web: fast, secure, and scalable by design. We say that they are the future of e-commerce as well (enterprise included) and this tutorial aims to demonstrate our statement. Before getting started, you can get a high-level overview of how it works on the [Contentful blog](https://www.contentful.com/blog/2018/11/07/how-build-static-site-ecommerce-jekyll-contentful-commerce-layer/) and play with the live demo [here](https://contentful-commerce.netlify.com/).
